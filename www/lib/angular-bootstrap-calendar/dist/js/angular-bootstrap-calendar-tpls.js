...
(function (window, angular) {
    ...
    angular.module('mwl.calendar').run([
        ...
        function ($templateCache) {
            ...
            $templateCache.put('src/templates/calendarHourList.html', '<div ng-controller="DashCtrl" class="cal-day-panel-hour"><div class="cal-day-hour" ng-click="createEventModal(hour)" ng-repeat="hour in vm.hours track by $index"><div class="row-fluid cal-day-hour-part"><div class="span1 col-xs-1"><strong ng-bind="hour.label"></strong></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 30"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 30"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 15"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div><div class="row-fluid cal-day-hour-part" ng-show="vm.dayViewSplit < 15"><div class="span1 col-xs-1"></div><div class="span11 col-xs-11"></div></div></div></div>');
        ...
        function ($scope, $timeout, $window, $locale, moment, calendarTitle, calendarDebounce) {
            ...
            var refreshCalendar = calendarDebounce(function () {
                if (calendarTitle[$scope.view]) {
                    ...
                    $scope.$parent.$parent.viewTitle = moment($scope.currentDay);//Customized
                }
